...
/* ────────────────────────────────────────────────────────────────────────
   ...
   Faithful port of the "Marketing / platform" design. The only departures
   from the static mock are live destinations: every signup call to action
   funnels into the owner-signup flow (`/register-gym`) and "Book a demo"
   opens a mail draft. The nav / footer anchors stay in-page like the design.
   ──────────────────────────────────────────────────────────────────────── */

/** Where every "start / trial" button sends the visitor. */
const SIGNUP_HREF = '/register-gym';
/** Secondary "Book a demo" destination. */
const DEMO_HREF = 'mailto:hello@formacore.io';
