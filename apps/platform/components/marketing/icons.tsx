...
export const I = {
  ...
  stretching:
    'M15 5a1 1 0 1 0 2 0 1 1 0 1 0-2 0 M5 20l5-.5 1-2 M18 20v-5h-5.5l2.5-6.5-5.5 1 1.5 2',
  stretching2:
    'M6.5 21l3.5-5 M5 11l7-2 M16 21l-4-7v-5l7-4 M9.007 6a2 2 0 1 0 4 0 2 2 0 1 0-4 0',
  barbell:
