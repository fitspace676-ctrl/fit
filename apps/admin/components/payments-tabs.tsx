...
// at the top of each hub tab's index page; drill-down routes (plan/order detail,
// new/edit forms) intentionally omit it. The retail catalog lives on its own
// top-level Shop destination (`/shop`), not as a Payments sub-tab.
