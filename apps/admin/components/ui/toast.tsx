...
// @fit/web — member portal toast system.
//
// A lightweight, dependency-free toast: `ToastProvider` renders the fixed stack
// (above the mobile tab bar) and `useToast()` hands any client component a
// `toast(message, tone?)` function. Toasts auto-dismiss after ~2.6s.
