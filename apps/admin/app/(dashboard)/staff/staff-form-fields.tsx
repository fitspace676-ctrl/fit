 ...
 *
 * `locationId` is the branch that window staffs, when it has one - a split shift
 * can put its morning at one door and its evening at another, so the branch rides
 * on the block rather than on the day.
 */
export type DayBlock = { start: string; end: string; locationId?: string };
