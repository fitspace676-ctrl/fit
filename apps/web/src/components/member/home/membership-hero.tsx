...
export function MembershipHero({
  ...
  return (
    <>
      <div className="relative overflow-hidden rounded-card bg-[linear-gradient(135deg,#7C3AED,#EC4899)] p-5 text-white shadow-[0_24px_60px_-24px_rgba(80,68,210,0.8)] sm:p-6">
        <span
          aria-hidden
