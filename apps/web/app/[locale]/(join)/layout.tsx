 ...
 *
 * The route group changes no URLs: the wizard stays at `/checkout`. It exists
 ...
 * page links to `/checkout`); the brand mark is their way back out, and the
      ...
      <div className="relative flex min-h-screen flex-col">
        <header className="border-b border-ink-100 dark:border-white/10">
          <div className="mx-auto flex h-16 max-w-[1200px] items-center justify-between gap-3 px-4 sm:px-6 lg:px-8">
            {/* Home, not `/home`: a signed-out visitor has no member home to land on. */}
