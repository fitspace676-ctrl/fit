...
// DSN, so the bundle is inert until one is configured. Superadmin is on Next
// 15.1, which predates `instrumentation-client.ts`, so initialise from a
// layout-level client component instead.
