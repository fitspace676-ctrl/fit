...
const KA: ReportStrings = {
  ...
  catalogue: {
    ...
    'stock-inventory': {
      ...
      description:
        'ყველა პროდუქტისა და ვარიანტის მიმდინარე მარაგი, ერთეულის თვითღირებულება და მარაგის ღირებულება, მცირე მარაგის ზღვარი და სტატუსი მის მიმართ (მარაგშია, მცირე მარაგი, ამოწურულია, არ ითვლება). ფილიალის არჩევისას ნაჩვენებია ამ ფილიალის მარაგი.',
      columns: {
        product: 'პროდუქტი',
        variant: 'ვარიანტი',
        sku: 'SKU',
    ...
    'trainer-activity': {
      ...
      description:
        'რა გააკეთა თითოეულმა მწვრთნელმა პერიოდში: ჩატარებული კლასები და PT სესიები, რამდენი სხვადასხვა წევრი გაწვრთნა და როგორ დასრულდა კლასების ჯავშნები - დაესწრო, გაუქმდა, არ მოვიდა. ფილიალის სვეტში ის ფილიალებია, სადაც ეს სამუშაო შესრულდა.',
      columns: {
        trainer: KA_COMMON.trainer,
        location: KA_COMMON.location,
    ...
    'staff-schedule': {
      ...
      description:
        'დაგეგმილი სამუშაო დრო: კვირეული ცვლების შაბლონი, დაპროექტებული პერიოდის ყველა დღეზე, რომელზეც მოდის. ფილიალის სვეტში ცვლის ფილიალია, ან ჩაწერილი ტექსტი, თუ ფილიალი არ მოიძებნა.',
      columns: {
        staff: 'თანამშრომელი',
        role: 'როლი',
        date: KA_COMMON.date,
