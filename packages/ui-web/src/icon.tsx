...
//
// This is the consolidated set — the union of what the admin console and member
// portal each shipped their own copy of (T1.3). It carries every glyph either
// app used, so moving both onto it drops nothing.
