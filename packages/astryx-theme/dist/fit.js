 ...
 * Generated: 2026-07-05T13:18:01.431Z
 */

/**
 * fit theme — built by `pnpm exec astryx theme build`
 * Import the CSS file alongside this module:
 *
 *   import { fitTheme } from './fit';
 *   import './fit.css';
 */
export const fitTheme = {
  ...
  tokens: {
    ...
    "--font-family-body": "var(--font-manrope), Manrope, system-ui, -apple-system, BlinkMacSystemFont, sans-serif",
    "--font-family-heading": "var(--font-archivo), Archivo, var(--font-manrope), system-ui, sans-serif",
    ...
    "--color-accent": "light-dark(#6257E3, #9184F1)",
    "--color-accent-muted": "light-dark(#E8E6FD, #312A74)",
    ...
    "--color-text-accent": "light-dark(#5044D2, #B5AEF7)",
    ...
    "--color-icon-accent": "light-dark(#5044D2, #B5AEF7)",
    ...
    "--color-success": "light-dark(#12B76A, #32D583)",
    "--color-error": "light-dark(#EF4444, #F97066)",
    "--color-warning": "light-dark(#F79009, #FDB022)",
    ...
    "--color-border-blue": "light-dark(#84CAFF, #175CD3)",
    "--color-icon-blue": "light-dark(#1570EF, #84CAFF)",
    "--color-text-blue": "light-dark(#175CD3, #B2DDFF)",
